...
to download cat/dog dataset, from within this directory run `curl -o Cat_Dog_data.zip https://datasets-349058029.s3.us-west-2.amazonaws.com/cat_dog_classifier/animals.zip && unzip Cat_Dog_data.zip && rm Cat_Dog_data.zip`
